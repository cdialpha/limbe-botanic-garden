...
const QuickSummary = () => {
  return (
    <div className="pt-10 pb-10">
      <div className="flex flex-col md:flex-row w-11/12 max-w-screen-2xl ml-5 mr-5 md:ml-auto md:mr-auto bg-glass-light backdrop-blur-sm md:bg-transparent rounded-2xl mt-10">
        <div className="z-10 ml-auto mr-auto mt-5 md:mt-auto md:mb-auto w-40 md:w-96"></div>
        Limbe Botanic Garden is a beautiful and must-visit destination for
        anyone traveling to Cameroon. It is renowned for being one of the most
        diverse and oldest gardens in Africa, with a fascinating history that
        dates back to 1892. One of the primary reasons why visitors should
        consider exploring this garden is its rich diversity. The garden is home
        to over 3,000 plant species from Cameroon and around the world, with
        many of these plants being rare and endangered species. It is a true
        marvel of biodiversity, with countless vibrant colors and unique
        ...
        great place to relax and unwind, with several walking trails, picnic
        areas, and an outdoor café. It is an ideal destination for families and
